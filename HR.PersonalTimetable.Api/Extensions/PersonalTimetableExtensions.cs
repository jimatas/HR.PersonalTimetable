...
namespace HR.PersonalTimetable.Api.Extensions
{
    public static class PersonalTimetableExtensions
    {
        ...
        /// <returns></returns>
        public static bool VerifyCreateAccess(this Models.PersonalTimetable personalTimetable, string userNameToVerify)
        {
        ...
        /// <param name="personalTimetable"></param>
        /// <returns></returns>
        public static Element ToElement(this Models.PersonalTimetable personalTimetable)
        {
