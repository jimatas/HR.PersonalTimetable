...
namespace HR.PersonalTimetable.Api.Extensions
{
    ...
    {
        /// <summary>
        /// Concatenates the data contained in the current string with the specified salt value and returns the SHA256 hash of the result.
        /// </summary>
        ...
        /// <returns>A lower-cased hexadecimal string containing the SHA256 hash.</returns>
        public static string ToSha256(this string data, string salt, Encoding encoding = null)
        {
            return ToHexString(ToSha256((encoding ?? Encoding.UTF8).GetBytes(data), (encoding ?? Encoding.UTF8).GetBytes(salt)));
        ...
        /// <summary>
        /// Concatenates the data contained in the current byte array with the specified salt value and returns the SHA256 hash of the result.
        /// </summary>
